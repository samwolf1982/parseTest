...
$way=plugins_url();
echo '<form  method="post" action="'.$way.'/megaparse/php5/scanx.php">  ';
?>

  <select name="path">
     <option value="http://anti-free.ru/forum/showthread.php?t=58815&page=132">Start</option>
  <!--  http://anti-free.ru/forum/showthread.php?t=58815&page=132 -->
...
<hr>
 ...
 <form hidden="true" method="post" action="php5/scanx.php">
  <select name="path">
...
//$way=plugin_dir_path(__FILE__);
$way=plugins_url();
echo '<form  method="post" action="'.$way.'/megaparse/php5/clear_last.php">  ';
 ?>
